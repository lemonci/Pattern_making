...
App.newDocument("back-truck2")
App.setActiveDocument("back-truck2")
App.ActiveDocument=App.getDocument("back-truck2")
Gui.ActiveDocument=Gui.getDocument("back-truck2")
...
#spline = Draft.makeBSpline(points,closed=False,face=True,support=None)
#draw roated sleeve lower frame
...
#line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)
#points = [FreeCAD.Vector(sleeveTopXS,sleeveTopYS,0.0),FreeCAD.Vector(sleeveDownRightXR, sleeveDownRightYR,0.0)]
#line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)
...
points = [FreeCAD.Vector(backcentralcut0X,backcentralcut0Y), FreeCAD.Vector(backcentralcut1X,backcentralcut1Y), FreeCAD.Vector(backcentralcut2X,backcentralcut2Y), FreeCAD.Vector(backArmHoleX0,backArmHoleY0), FreeCAD.Vector(SS,BL)]
spline = Draft.makeBSpline(points,closed=False,face=True,support=None)

#draw waist baseline
pl.Base = FreeCAD.Vector(BS,WL-C,0.0)
points = [FreeCAD.Vector(BS,WL-C,0.0),FreeCAD.Vector(BS,WL,0.0)]
line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)
pl.Base = FreeCAD.Vector(BS,WL-C,0.0)
points = [FreeCAD.Vector(BS,WL-C,0.0),FreeCAD.Vector(SS,WL-C,0.0)]
#line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)
pl.Base = FreeCAD.Vector(SS,WL-C,0.0)
points = [FreeCAD.Vector(SS,WL-C,0.0),FreeCAD.Vector(SS,WL,0.0)]
#line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)

#draw back side curve
sideOffsetX = SS - D/4
points = [FreeCAD.Vector(SS , BL), FreeCAD.Vector(sideOffsetX, 0.25*BL + 0.75*WL), FreeCAD.Vector(sideOffsetX, WL)]
bez = Draft.makeBezCurve(points,closed=False,support=None)
points = [FreeCAD.Vector(sideOffsetX, WL), FreeCAD.Vector(0.25*SS +  0.75*sideOffsetX, 0.35*(WL - C + 7.5) + 0.65*WL), FreeCAD.Vector(0.5*SS +  0.5*sideOffsetX, 0.5*(WL - C + 7.5) + 0.5*WL), FreeCAD.Vector(0.75*SS +  0.25*sideOffsetX, 0.65*(WL - C + 7.5) + 0.35*WL), FreeCAD.Vector(SS, WL - C + 7.5)]
spline = Draft.makeBSpline(points,closed=False,face=True,support=None)
points = [FreeCAD.Vector(BS,WL-C), FreeCAD.Vector(0.5*BS + 0.5*SS, WL-C), FreeCAD.Vector(SS, WL - C + 7.5)]
bez = Draft.makeBezCurve(points,closed=False,support=None)

#draw back diamond dart
diamondCenterX = (SS + BS)*0.5
pl.Base = FreeCAD.Vector(diamondCenterX,diamondCenterY,0.0)
points = [FreeCAD.Vector(diamondCenterX-D/8, WL),FreeCAD.Vector(diamondCenterX,BL + 25,0.0)]
line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)
points = [FreeCAD.Vector(diamondCenterX+D/8, WL),FreeCAD.Vector(diamondCenterX,BL + 25,0.0)]
line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)
points = [FreeCAD.Vector(diamondCenterX-D/8, WL),FreeCAD.Vector(diamondCenterX,WL - 100,0.0)]
line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)
points = [FreeCAD.Vector(diamondCenterX+D/8, WL),FreeCAD.Vector(diamondCenterX,WL - 100,0.0)]
line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)
...
#Draft.autogroup(Draft.makePoint(SS, WL - C + 7.5))
