...
App.newDocument("front-trunk")
App.setActiveDocument("front-trunk")
App.ActiveDocument=App.getDocument("front-trunk")
Gui.ActiveDocument=Gui.getDocument("front-trunk")
...
line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)
points = [FreeCAD.Vector(sleeveDownLeftXR,sleeveDownLeftYR,0.0),FreeCAD.Vector(sleeveTopXS,sleeveTopYS,0.0)]
line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)
...
#front frames - waist
pl.Base = FreeCAD.Vector(CFL,WL-C,0.0)
points = [FreeCAD.Vector(CFL,WL-C,0.0),FreeCAD.Vector(CFL, WL,0.0)]
line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)
#pl.Base = FreeCAD.Vector(CFL,WL-C,0.0)
#points = [FreeCAD.Vector(CFL,WL-C,0.0),FreeCAD.Vector(SS,WL-C,0.0)]
#line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)
#pl.Base = FreeCAD.Vector(SS,WL-C,0.0)
#points = [FreeCAD.Vector(SS,WL-C,0.0),FreeCAD.Vector(SS,WL,0.0)]
#line = Draft.makeWire(points,placement=pl,closed=False,face=True,support=None)

#draw front side curve
sideOffsetX = SS + D/4
...
spline = Draft.makeBSpline(points,closed=False,face=True,support=None)
points = [FreeCAD.Vector(CFL,WL-C), FreeCAD.Vector(0.5*CFL + 0.5*SS, WL-C), FreeCAD.Vector(SS, WL - C + 7.5)]
bez = Draft.makeBezCurve(points,closed=False,support=None)
