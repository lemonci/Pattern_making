...
App.newDocument("Pattern")
App.setActiveDocument("Pattern")
App.ActiveDocument=App.getDocument("Pattern")
Gui.ActiveDocument=Gui.getDocument("Pattern")
...
'''
points = [FreeCAD.Vector(sleeveTopXS,sleeveTopYS),
FreeCAD.Vector(frontSleevePeakXR,frontSleevePeakYR),
FreeCAD.Vector(frontSleeveIntersectXAdjR,frontSleeveIntersectYAdjR),
FreeCAD.Vector(twooverthreeFrontSleeveXR,twooverthreeFrontSleeveYR),
FreeCAD.Vector(triangleFrontHalfSleeveXR,triangleFrontHalfSleeveYR)]

points = [FreeCAD.Vector(frontCollarX,FC),
FreeCAD.Vector(,frontCollarY),
FreeCAD.Vector(CFL,frontCollarY)]

Draft.autogroup(Draft.makePoint(twooverthreeFrontSleeveXR,twooverthreeFrontSleeveYR))
Draft.autogroup(Draft.makePoint(frontCollarX,frontCollarY))'''